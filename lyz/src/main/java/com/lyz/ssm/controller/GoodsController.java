package com.lyz.ssm.controller;
...
import com.lyz.ssm.common.dto.BootStrapTableResult;
import com.lyz.ssm.entity.Goods;
import com.lyz.ssm.enums.BizExceptionEnum;
import com.lyz.ssm.service.GoodsService;
...
public class GoodsController {
    ...
    public  BaseResult<Object> buy(@CookieValue(value = "userPhone", required = false) Long userPhone,
                                  @Validated Goods goods, BindingResult result, HttpSession httpSession) {
    ...
    @ResponseBody
    public  BaseResult<Object> testDistributedTransaction(@Validated Goods goods, BindingResult result) {
