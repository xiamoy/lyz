...
<%
	List<Category> categorys = (List<Category>)request.getAttribute(Constants.category_all);
	Map<String,List<Product>> products =(Map<String,List<Product>>) request.getAttribute(Constants.product_on_category);
	System.out.println("home.jsp :"+categorys+";"+products);
	if(categorys!=null){
		for(Category c:categorys){
			String cid = c.getCid();
			List<Product> productList = products.get(cid);
			System.out.println(cid+":"+c.getCname()+"|| ");
	...
	String user = (String)request.getAttribute("login_user");
					...
					<ul>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="../person/information.html"> <img
